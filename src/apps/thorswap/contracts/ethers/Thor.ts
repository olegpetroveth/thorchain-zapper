...
export declare namespace ThorToken {
...
export interface ThorInterface extends utils.Interface {
  functions: {
...
export interface Thor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThorInterface;
  ...
  functions: {
    ...
    checkpoints(
      ...
      overrides?: CallOverrides,
    ): Promise<[ThorToken.CheckpointStructOutput]>;
