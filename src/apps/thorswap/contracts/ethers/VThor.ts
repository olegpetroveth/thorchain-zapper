...
export interface VThorInterface extends utils.Interface {
  functions: {
...
export interface VThor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VThorInterface;
  ...
  functions: {
    ...
    DOMAIN_SEPARATOR(overrides?: CallOverrides): Promise<[string] & { domainSeparator: string }>;
    ...
    delegates(delegator: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string] & { delegatee: string }>;
